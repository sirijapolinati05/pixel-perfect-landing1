    ...
    <section className="relative overflow-hidden bg-[#15203c] px-4 sm:px-6 md:px-8 lg:px-14 xl:px-20 2xl:px-28 pb-12 sm:pb-16 md:pb-20 lg:pb-24 xl:pb-28 pt-20 sm:pt-24 md:pt-24 lg:pt-28 xl:pt-32 text-white">
      ...
      <div className="relative mx-auto max-w-[1180px]">
        <div className="max-w-[760px] pt-6 sm:pt-8 md:pt-10 lg:pt-20">
          ...
          <div className="group relative mt-6 sm:mt-8 max-w-full sm:max-w-[520px] overflow-hidden rounded-[22px] sm:rounded-[24px] border border-white/20 bg-white/10 shadow-[0_25px_60px_rgba(2,6,34,0.34)] backdrop-blur-xl md:rounded-[26px]
          ...
          hover:-translate-y-2 hover:scale-[1.02] hover:border-white/40 hover:shadow-[0_35px_80px_rgba(2,6,34,0.55)]">
            ...
            <div className="relative flex flex-col md:flex-row">
              {heroStats.map(([value, lineOne, lineTwo], index) => (
                <div
                  key={value}
                  className={`flex-1 px-4 sm:px-6 md:px-7 py-4 sm:py-5 ${
                    index < heroStats.length - 1
                      ? "border-b border-white/15 md:border-b-0 md:border-r"
                      : ""
                  } border-white/15`}
                >
                  <p className="text-3xl sm:text-4xl md:text-5xl font-semibold leading-none text-[#68e1d0] transition duration-300 group-hover:text-white">
                    {value}
                  </p>
                  <p className="mt-2 max-w-[120px] text-sm sm:text-lg md:text-xl leading-6 sm:leading-7 text-white">
                    {lineOne}
                    <br />
                    {lineTwo}
                  </p>
          ...
          <button
            type="button"
            className="mt-5 w-full sm:w-auto rounded-full bg-[linear-gradient(180deg,#31b9ee_0%,#249fd8_100%)] px-6 sm:px-8 md:px-10 lg:px-8 py-3 text-sm sm:text-base md:text-lg lg:text-[15px] font-semibold text-white 
