    ...
    >
      ...
      <div className="page-shell relative z-10 mx-auto">
        <div className="max-w-[760px] pt-6 sm:pt-8 md:pt-10 lg:pt-20">
          <h1 className="micro-market-hero-title max-w-[680px] text-[36px] font-semibold leading-[0.95] tracking-[-0.03em] sm:text-[40px] md:text-[48px] lg:text-[50px]">
            Decoding the Niche.
            <br />
            Defining the Future.
          </h1>

          <p className="micro-market-hero-copy mt-4 max-w-[860px] text-[16px] leading-6 text-white/95 sm:mt-5 sm:text-[18px] sm:leading-7 md:text-[20px] md:leading-8">
          ...
          <div className="group relative mt-6 max-w-full overflow-hidden rounded-[22px] border border-white/20 bg-white/10 shadow-[0_25px_60px_rgba(2,6,34,0.34)] backdrop-blur-xl transition-all duration-500 ease-in-out hover:-translate-y-2 hover:scale-[1.02] hover:border-white/40 hover:shadow-[0_35px_80px_rgba(2,6,34,0.55)] sm:mt-8 sm:rounded-[24px] md:rounded-[26px]">
            ...
            <div className="relative flex flex-row divide-x divide-white/15">
              {heroStats.map(([value, lineOne, lineTwo]) => (
                ...
                >
                  <p className="micro-market-hero-stat-value text-2xl font-semibold leading-none text-[#68e1d0] transition duration-300 group-hover:text-white sm:text-4xl md:text-5xl">
                    {value}
                  </p>
                  <p className="micro-market-hero-stat-label mt-2 text-[16px] leading-5 text-white sm:text-[18px] sm:leading-7 md:text-[20px]">
                    {lineOne}
                    <br />
                    {lineTwo}
                  </p>
